  ...
  Pokemons: [
    {
      name: "Bulbasaur",
      ntnlnum: "#001",
      image: "https://img.pokemondb.net/artwork/vector/large/bulbasaur.png",
      types: ["Grass", "Poison"],
      description:
    ...
    },
    {
      name: "Ivysaur",
      ntnlnum: "#002",
      image: "https://img.pokemondb.net/artwork/vector/large/ivysaur.png",
      types: ["Grass", "Poison"],
      description:
    ...
    },
    {
      name: "Venusaur",
      ntnlnum: "#003",
      image: "https://img.pokemondb.net/artwork/vector/large/venusaur.png",
      types: ["Grass", "Poison"],
      description:
    ...
    },
    {
      name: "Charmander",
      ntnlnum: "#004",
      image: "https://img.pokemondb.net/artwork/vector/large/charmander.png",
      types: ["Fire"],
      description:
    ...
    },
    {
      name: "Charmeleon",
      ntnlnum: "#005",
      image: "https://img.pokemondb.net/artwork/vector/large/charmeleon.png",
      types: ["Fire"],
      description:
    ...
    },
    {
      name: "Charizard",
      ntnlnum: "#006",
      image: "https://img.pokemondb.net/artwork/vector/large/charizard.png",
      types: ["Fire", "Flying"],
      description:
    ...
    },
    {
      name: "Caterpie",
      ntnlnum: "#010",
      image: "https://img.pokemondb.net/artwork/vector/large/caterpie.png",
      types: ["Bug"],
      description:
    ...
    },
    {
      name: "Pidgey",
      ntnlnum: "#016",
      image: "https://img.pokemondb.net/artwork/vector/large/pidgey.png",
      types: ["Normal", "Flying"],
      description:
    ...
    },
    {
      name: "Rattata",
      ntnlnum: "#019",
      image: "https://img.pokemondb.net/artwork/vector/large/rattata.png",
      types: ["Normal"],
      description:
    ...
    },
    {
      name: "Arbok",
      ntnlnum: "#024",
      image: "https://img.pokemondb.net/artwork/vector/large/arbok.png",
      types: ["Poison"],
      description:
    ...
    },
    {
      name: "Pikachu",
      ntnlnum: "#025",
      image: "https://img.pokemondb.net/artwork/vector/large/pikachu-alt2.png",
      types: ["Electric"],
      description:
    ...
    },
    {
      name: "Sandshrew",
      ntnlnum: "#027",
      image: "https://img.pokemondb.net/artwork/vector/large/sandshrew.png",
      types: ["Ground"],
      description:
    ...
    },
    {
      name: "Jigglypuff",
      ntnlnum: "#039",
      image: "https://img.pokemondb.net/artwork/vector/large/jigglypuff.png",
      types: ["Fairy"],
      description:
    ...
    },
    {
      name: "Mankey",
      ntnlnum: "#056",
      image: "https://img.pokemondb.net/artwork/vector/large/mankey.png",
      types: ["Fighting"],
      description:
    ...
    },
    {
      name: "Poliwrath",
      ntnlnum: "#062",
      image: "https://img.pokemondb.net/artwork/vector/large/poliwrath.png",
    ...
    },
    {
      name: "Geodude",
      ntnlnum: "#074",
      image: "https://img.pokemondb.net/artwork/vector/large/geodude.png",
      types: ["Rock", "Ground"],
      description:
    ...
    },
    {
      name: "Magnemite",
      ntnlnum: "#081",
      image: "https://img.pokemondb.net/artwork/vector/large/magnemite.png",
    ...
    },
    {
      name: "Cloyster",
      ntnlnum: "#091",
      image: "https://img.pokemondb.net/artwork/vector/large/cloyster.png",
      types: ["Water", "Ice"],
      description:
    ...
    },
    {
      name: "Gastly",
      ntnlnum: "#092",
      image: "https://img.pokemondb.net/artwork/vector/large/gastly.png",
      types: ["Ghost"],
      description:
    ...
    },
    {
      name: "Haunter",
      ntnlnum: "#093",
      image: "https://img.pokemondb.net/artwork/vector/large/haunter.png",
      types: ["Ghost", "Poison"],
      description:
    ...
    },
    {
      name: "Gengar",
      ntnlnum: "#094",
      image: "https://img.pokemondb.net/artwork/vector/large/gengar.png",
      types: ["Ghost", "Poison"],
      description:
    ...
    },
    {
      name: "Scyther",
      ntnlnum: "#123",
      image: "https://img.pokemondb.net/artwork/vector/large/scyther.png",
      types: ["Bug", "Flying"],
      description:
    ...
    },
    {
      name: "Omanyte",
      ntnlnum: "#138",
      image: "https://img.pokemondb.net/artwork/vector/large/omanyte.png",
      types: ["Rock", "Water"],
      description:
    ...
    },
    {
      name: "Aerodactyl",
      ntnlnum: "#142",
      image: "https://img.pokemondb.net/artwork/vector/large/aerodactyl.png",
      types: ["Flying"],
      description:
    ...
    },
    {
      name: "Articuno",
      ntnlnum: "#144",
      image: "https://img.pokemondb.net/artwork/vector/large/articuno.png",
      types: ["Ice", "Flying"],
      description:
    ...
    },
    {
      name: "Azumarill",
      ntnlnum: "#184",
      image: "https://img.pokemondb.net/artwork/vector/large/azumarill.png",
      types: ["Water", "Fairy"],
      description:
    ...
    },
    {
      name: "Umbreon",
      ntnlnum: "#197",
      image: "https://img.pokemondb.net/artwork/vector/large/umbreon.png",
      types: ["Dark"],
      description:
    ...
    },
    {
      name: "Murkrow",
      ntnlnum: "#198",
      image: "https://img.pokemondb.net/artwork/vector/large/murkrow.png",
      types: ["Dark", "Flying"],
      description:
    ...
    },
    {
      name: "Forretress",
      ntnlnum: "#205",
      image: "https://img.pokemondb.net/artwork/vector/large/forretress.png",
      types: ["Bug", "Steel"],
      description:
...
const reducer = (state = initialState, action) => {
  ...
  */
  ...
  switch (action.type) {
    // reducer functions
    case "TOGGLE_POKEMON":
      return { ...state, togglePokemon: !state.togglePokemon };
    case "SET_POKEMON":
      return { ...state, togglePokemon: action.payload };
